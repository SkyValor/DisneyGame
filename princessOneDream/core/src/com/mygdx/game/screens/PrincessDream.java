...
public class PrincessDream implements Screen {

    private PrincessOneDream princessOneDream;
    private Texture img;


    public PrincessDream(PrincessOneDream princessOneDream) {
        this.princessOneDream = princessOneDream;
        img = new Texture("Capa Hackaton.png");
    }
    ...
    private void userInputs() {
        ...
        if (Gdx.input.isTouched()) {
            princessOneDream.setScreen(new StartGame(princessOneDream));
        }
    }
}
